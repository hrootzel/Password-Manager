...
private:
    ...
    std::string nvsBleEnabled = "bleKeyboard";
...
public:
    ...
    bool getBleKeyboardEnabled() const { return bleKeyboardEnabled; }
    ...
    void setBleKeyboardEnabled(bool enabled) { bleKeyboardEnabled = enabled; }
